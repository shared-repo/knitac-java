...
public class Ex08IO {
	...
	public static void main(String[] args) throws Exception {
		...
		//1. char[] <-> byte[] 변환 직접 처리 (텍스트 데이터 IO)
...
//				fis1.read(buffer1,			//스트림에서 읽은 데이터를 저장할 byte[] 변수
//						  0, 				//읽은 데이터를 buffer1의 어디부터 저장할지 지정
//						  buffer1.length);	//읽기 원하는 양 ( 여기서는 256byte )
//			
...
//		InputStreamReader reader2 = new InputStreamReader(istream2); // byte[] -> char[]변환 기능
...
//		Item item2 = (Item)oistream4.readObject();//파일에서 byte[] 데이터를 읽고 객체로 복원
//
